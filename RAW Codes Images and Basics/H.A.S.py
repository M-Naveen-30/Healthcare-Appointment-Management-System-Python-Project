...
p.init()
p.display.set_caption("SALEM GH APPOINTMENT SYSTEM")
ps1 = p.display.set_mode((500, 500))
ps = p.image.load("hospital_logo.jpg")
...
def pick_timing():
    ...
    def book_appointment():
        global doctor_name, appt_date, appt_time, purpose, token
        while True:
            try:
        ...
        appt_date = show_may_calendar()
        appt_time = pick_timing()
